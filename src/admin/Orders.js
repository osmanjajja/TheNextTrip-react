...
const Orders = () => {
  ...
  const showOrdersLength = () => {
    if (orders.length > 0) {
      return <h1 className="text-danger display-2 my-2 p-1 border">Total Place orders: {orders.length}</h1>;
    } else {
    ...
    >
      <div className="row">
        <div className="col-md-8 offset-md-2">
          ...
          {orders.map((o, oIndex) => {
            return (
              <div className="my-5" key={oIndex} style={{ borderBottom: "5px solid indigo" }}>
                <h2 className="mb-5">
