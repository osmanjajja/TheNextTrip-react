    ...
    return (
      showViewProductButton && (
        <Link to={`/product/${product._id}`} className="mr-2">
          <button className="btn btn-info mt-2 mb-2 card-btn-1" id="view-product">
            More Info!
          </button>
        </Link>
      )
    ...
    <div className="border rounded shadow">
      <div className="card m-2 ">
        ...
        <div class="card-body m-0 p-0">
          <div className="d-flex justify-content-between mx-2 mb-0">
            <h6 className="font-weight-bold h6" style={{ fontWeight: "600", fontSize: "0.8em", color: "#eb07c1" }}>
              {product.subname}
            </h6>
            <StarRating />
          </div>
          <div className="mt-2 px-3">
            <p className="badge badge-warning badge-pill shadow">Price : Rs {product.price}</p>
          </div>
        </div>
      </div>
      <div className="text-justify m-2 p-2" style={{ fontSize: "14px", fontWeight: "500" }}>
        ...
        <div className="d-flex justify-content-around p-2 m-0">
          ...
          <p className=" text-warning mx-1" style={{ fontSize: "11px", fontWeight: "600" }}>
            Added on {moment(product.createdAt).fromNow()}
          </p>
          <p className="text-info mx-1" style={{ fontWeight: "600", fontSize: "0.7em" }}>
            <span>Category: </span>
