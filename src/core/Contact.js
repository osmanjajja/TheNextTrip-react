            ...
            <div className="card my-4">
              <div className="card-header text-center bg-success">
                ...
                <p className="text-justify m-3 text-white">
                  Founded in 2022, NextTrip is Pakistan’s online travel marketplace bringing both the traveler and
                  expert Travel-Agents on a common platform.
                </p>
              </div>
                ...
                <ul className="list-group">
                  <li className="list-group-item">
                    <h4 className="text-info">
                      <i class="fa fa-thumb-tack fa-1x" aria-hidden="true"></i> Location
                    </h4>
                  </li>
                  <li className="list-group-item">NextTrip Agency</li>
                  <li className="list-group-item ">Johar Town, Lahore</li>
                  <li className="list-group-item">Pakistan</li>
                </ul>
              </div>
            </div>
          </div>
          <div className="col-xs-12 col-sm-6">
            <div className="card my-4 px-3">
              ...
              <form method="POST" action="">
                ...
                <div>
                  <button className="btn btn-primary" type="submit" value="Submit" name="button">
                    Submit
                  </button>
                </div>
              </form>
        ...
        <div className="row">
          <div className="col-md-6">
            ...
            <p className="text-justify p-2">
              ...
              letters. There are many variants of passaages of Lorem Ipsum available, but the majority have suffered
