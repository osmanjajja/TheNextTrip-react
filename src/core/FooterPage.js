  ...
  return (
    <MDBFooter color="blue-grey" className="page-footer font-small lighten-5 pt-0">
      ...
      <MDBContainer className="mt-5 mb-4 text-center text-md-left">
        <MDBRow className="mt-3">
          <MDBCol md="3" lg="4" xl="3" className="mb-4 dark-grey-text">
            <h6 className="font-weight-bold">NextTrip</h6>
            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: "70px" }} />
            <p className="text-justify">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum sem diam, vestibulum non eros sed,
              gravida hendrerit ipsum. Aenean pharetra ultrices risus id convallis. Maecenas id turpis quis velit
              ultricies commodo. Nunc elementum risus ante. Praesent non leo eu massa tristique ullamcorper. Vestibulum
              porttitor.
            </p>
          </MDBCol>
          ...
          <MDBCol md="4" lg="3" xl="3" className="mb-4 dark-grey-text">
            ...
            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px" }} />
            <p>
              <i className="fa fa-home mr-3" /> 123Office,Xyz Steet,Lahore,Pakistan.
            </p>
            <p>
              <i className="fa fa-envelope mr-3" /> info@NextTrip
            </p>
            <p>
              <i className="fa fa-phone mr-3" /> +9234xxxxxxxx
            </p>
            <p>
              <i className="fa fa-print mr-3" /> +9234xxxxxxxx
            </p>
          </MDBCol>
        </MDBRow>
      </MDBContainer>
      <div className="footer-copyright text-center py-3 bg-success">
        <MDBContainer fluid>
          &copy; {new Date().getFullYear()} Copyright: <a href="https://github.com/"> www.NextTrip.com</a>
        </MDBContainer>
      </div>
    </MDBFooter>
  );
