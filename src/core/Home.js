    ...
    <Layout title="" description="" className="container-fluid m-0 p-0">
      ...
      <div className="pt-3">
        <h2 className="text-center h2 mt-3 mb-3" id="home-popularplace">
          <span style={{ color: "#4caf50" }}>Popular </span>Places
        </h2>
        <div className="row">
        ...
        <h2 className="text-center h2 mt-3 mb-3">
          <span style={{ color: "#4caf50" }}>New </span>Places
        </h2>
        <div className="row">
      ...
      <h2 className="mb-3 p-3 text-center text-success font-weight-bold h2" id="homegallery">
        Gallery
      </h2>
      <Gallery />
    </Layout>
