...
const Search = () => {
  ...
  const searchedProducts = (results = []) => {
    return (
      <div>
        <h2 className="my-3 p-3 text-center text-warning">{searchMessage(searched, results)}</h2>
          ...
          <span className="input-group-text">
            <div className="input-group input-group-lg">
              <div className="col-sm-6 col-xs-12 col-md-6">
                <select className="btn mr-2" onChange={handleChange("category")} id="category-select">
              ...
              <div className="input-group d-block ml-2 col-xs-6 col-sm-4 col-md-3 mx-auto" style={{ border: "none" }}>
