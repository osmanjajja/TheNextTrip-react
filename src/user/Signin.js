...
const Signin = () => {
  ...
  const signUpForm = () => (
    <div className="row display-flex mt-3">
      <div
        ...
        id="login-intro-form"
      >
        <h2 className="text-center text-white h2 font-weight-bold mt-2">Hello Wanderer</h2>
      ...
      <div className="col-sm-8 col-xs-10 col-md-4 rounded-right py-4 px-3" id="login-intro">
        <h2 className="login-login-title text-center mt-2 h2">Welcome NextTrip</h2>
        <img className="img-fluid img-rounded" src={sideimage} alt="signup" />
        <p className="text-center text-warning">We Are Happy to see you here.</p>
      </div>
    </div>
  );
  ...
  const showLoading = () =>
    loading && (
      ...
      //     <h2>Loading...</h2>
      // </div>
      <LoadingOverlay active={loading} spinner text="Loading......" className="loader"></LoadingOverlay>
    );
