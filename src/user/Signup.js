    ...
    <div className="container mt-2">
      <div className="row display-flex">
        ...
        <div className="col-xs-12 col-sm-6 col-md-5 rounded-right my-3 shadow-lg" id="signup-intro">
          <h2 className="text-white text-center my-3 p-2 h2">Welcome to NextTrip</h2>
          <p className="text-center text-warning py-2">We Are Happy to see you here.</p>
          ...
          <p className="h5 text-center text-white py-1 my-1 font-weight-bold">Let's Explore the Pakistan !!!!</p>
        </div>
      </div>
    </div>
  );
